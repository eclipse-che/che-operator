...
func TestV1ToV2alpha1(t *testing.T) {
	...
	t.Run("Host-k8s", func(t *testing.T) {
		onFakeKubernetes(func() {
			...
			if v2.Spec.Host != "ingressDomain" {
				t.Errorf("Unexpected v2.Spec.Host: %s", v2.Spec.Host)
			}
		})
	})

	t.Run("Host-openshift", func(t *testing.T) {
...
func TestV2alpha1ToV1(t *testing.T) {
	...
	t.Run("Host-k8s", func(t *testing.T) {
		onFakeKubernetes(func() {
			...
			if v1.Spec.K8s.IngressDomain != "v2Host" {
	...
	t.Run("Host-openshift", func(t *testing.T) {
		onFakeOpenShift(func() {
			...
			if v1.Spec.Server.CustomCheProperties[routeDomainSuffixPropertyKey] != "v2Host" {
