...
func TestContainerBuildReconciler(t *testing.T) {
	...
	assert.True(t, test.IsObjectExists(ctx.ClusterAPI.Client, types.NamespacedName{Name: containerBuildReconciler.containerBuildCapability.GetUserClusterRoleName()}, &rbacv1.ClusterRole{}))
	...
	assert.True(t, test.IsObjectExists(ctx.ClusterAPI.Client, types.NamespacedName{Name: containerBuildReconciler.containerRunCapability.GetUserClusterRoleName()}, &rbacv1.ClusterRole{}))
	...
	assert.False(t, test.IsObjectExists(ctx.ClusterAPI.Client, types.NamespacedName{Name: containerBuildReconciler.containerBuildCapability.GetUserClusterRoleName()}, &rbacv1.ClusterRole{}))
	...
	assert.False(t, test.IsObjectExists(ctx.ClusterAPI.Client, types.NamespacedName{Name: containerBuildReconciler.containerRunCapability.GetUserClusterRoleName()}, &rbacv1.ClusterRole{}))
