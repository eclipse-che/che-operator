		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"selfSignedCert": {
						SchemaProps: spec.SchemaProps{
							Description: "Obsolete. The value of this flag is ignored. Che operator automatically propogates router certificate to Che server and some other components.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					...
					"tlsSupport": {
						SchemaProps: spec.SchemaProps{
							Description: "Instructs the operator to deploy Che in TLS mode. This is enabled by default.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
