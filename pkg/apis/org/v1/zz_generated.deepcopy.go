...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheClusterLabels) DeepCopyInto(out *CheClusterLabels) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheClusterLabels.
func (in *CheClusterLabels) DeepCopy() *CheClusterLabels {
	if in == nil {
		return nil
	}
	out := new(CheClusterLabels)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CheClusterSpec) DeepCopyInto(out *CheClusterSpec) {
	*out = *in
	...
	out.K8s = in.K8s
	out.PluginRegistry = in.PluginRegistry
