...
func (in *CheClusterSpecServer) DeepCopyInto(out *CheClusterSpecServer) {
	*out = *in
	if in.OverrideCheProperties != nil {
		in, out := &in.OverrideCheProperties, &out.OverrideCheProperties
		*out = make([]ChePropertyOverride, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChePropertyOverride) DeepCopyInto(out *ChePropertyOverride) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChePropertyOverride.
func (in *ChePropertyOverride) DeepCopy() *ChePropertyOverride {
	if in == nil {
		return nil
	}
	out := new(ChePropertyOverride)
	in.DeepCopyInto(out)
	return out
}
