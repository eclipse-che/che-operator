...
type CheClusterSpecImagePuller struct {
	...
	//
	// Please note that while this operator and its behavior is community-supported, its payload may be commercially-supported if you
	// use it for pulling commercially-supported images.
	Enable bool `json:"enable"`
