...
require (
	...
	github.com/devfile/devworkspace-operator v0.40.0
...
require (
	...
	github.com/onsi/gomega v1.41.0 // indirect; used for manifest generation
	github.com/operator-framework/operator-registry v1.71.0 // indirect
