...
func (in *Auth) DeepCopyInto(out *Auth) {
	*out = *in
	if in.OAccessTokenInactivityTimeoutSeconds != nil {
		in, out := &in.OAccessTokenInactivityTimeoutSeconds, &out.OAccessTokenInactivityTimeoutSeconds
		*out = new(int32)
		**out = **in
	}
	if in.OAccessTokenMaxAgeSeconds != nil {
		in, out := &in.OAccessTokenMaxAgeSeconds, &out.OAccessTokenMaxAgeSeconds
		*out = new(int32)
		**out = **in
	}
