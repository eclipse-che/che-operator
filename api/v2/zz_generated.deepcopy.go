...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheClusterOperands) DeepCopyInto(out *CheClusterOperands) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheClusterOperands.
func (in *CheClusterOperands) DeepCopy() *CheClusterOperands {
	if in == nil {
		return nil
	}
	out := new(CheClusterOperands)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CheClusterSpec) DeepCopyInto(out *CheClusterSpec) {
	*out = *in
	...
	in.Operands.DeepCopyInto(&out.Operands)
