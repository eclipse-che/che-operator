...
func (in *TrustedCerts) DeepCopyInto(out *TrustedCerts) {
	*out = *in
	if in.DisableMountingCaBundleIntoDevWorkspace != nil {
		in, out := &in.DisableMountingCaBundleIntoDevWorkspace, &out.DisableMountingCaBundleIntoDevWorkspace
		*out = new(bool)
		**out = **in
	}
	if in.CaBundleMountPaths != nil {
		in, out := &in.CaBundleMountPaths, &out.CaBundleMountPaths
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
