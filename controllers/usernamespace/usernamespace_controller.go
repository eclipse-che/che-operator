...
func (r *CheUserNamespaceReconciler) reconcileSCCPrivileges(
	username string,
	targetNs string,
	cc containercapabilties.ContainerCapability,
	...
	if !isContainerCapabilitiesEnabled {
		return r.clientWrapper.DeleteByKeyIgnoreNotFound(
			context.TODO(),
			types.NamespacedName{Name: cc.GetUserClusterRoleBindingName(), Namespace: targetNs},
			&rbacv1.RoleBinding{},
		)
	}
